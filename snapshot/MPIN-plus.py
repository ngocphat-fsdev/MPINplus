...
if args.prefix == "testNumStream":
    avg_df.to_csv(
        f"./exp_results/{args.prefix}_{args.dataset}_{args.k}_{args.base}_incre_{args.incre_mode}_window_{args.window}_epoch_{args.epochs}_eval_{args.eval_ratio}_stream_{args.stream}.csv",
        header=True,
        index=True,
    )
else:
    avg_df.to_csv(
        f"./exp_results/{args.prefix}_{args.dataset}_{args.k}_{args.base}_incre_{args.incre_mode}_window_{args.window}_epoch_{args.epochs}_eval_{args.eval_ratio}.csv",
        header=True,
        index=True,
    )
print("done!")
